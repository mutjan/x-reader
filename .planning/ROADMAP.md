...
- [ ] **Phase 7: Cleanup Existing Merge Logic** - Remove old similar news merge functionality and prepare for new grouping architecture
...
**Success Criteria** (what must be TRUE):
  ...
  3. Automatic backup mechanism preserves last 30 days of grouping history
...
| 7. Cleanup Existing Merge Logic | 0/0 | Not started | - |
